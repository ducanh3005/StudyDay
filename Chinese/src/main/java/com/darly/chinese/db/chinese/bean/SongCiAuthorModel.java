...
public class SongCiAuthorModel extends BaseBean implements Serializable {
    ...
    public String getName() {
        return StringUtil.isEmpty(name) ? "空数据" : name;
    }
    ...
    public String getDescription() {
        return StringUtil.isEmpty(description) ? "空数据" : description;
    }
    ...
    public String getShort_description() {
        return StringUtil.isEmpty(short_description) ? "空数据" : short_description;
    }
