...
let toYear: number = Number.parseInt(moment().format('YYYY'))
let toMonth: number = Number.parseInt(moment().format('MM'))
        ...
        return (
            <View style={styles.headerBar}>
                ...
                <TouchableOpacity
                    ...
                    <Text style={{ fontSize: 14, color: "#4E80F5" }} >{'last_month'}</Text>
                </TouchableOpacity>
