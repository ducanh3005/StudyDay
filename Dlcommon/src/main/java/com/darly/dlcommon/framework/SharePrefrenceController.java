 ...
 */
public class SharePrefrenceController {
    private Context context;
    private String name;
    private SharedPreferences sp;

    public SharePrefrenceController(Context context, String name) {
    ...
    public void putValue(String key, int postion) {
        ...
        editor.putInt(key, postion);
        editor.apply();
    }

    public void putValue(String key, boolean postion) {
        if (sp == null) {
            sp = context.getSharedPreferences(name, Context.MODE_PRIVATE);
        }
        SharedPreferences.Editor editor = sp.edit();
        editor.putBoolean(key, postion);
        editor.apply();
    }
    ...
    public boolean getValue(String key, boolean df) {
        if (sp == null) {
            sp = context.getSharedPreferences(name, Context.MODE_PRIVATE);
        }
