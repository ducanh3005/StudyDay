...
package com.darly.widget.sidemenu.util;
...
import com.darly.widget.sidemenu.animation.FlipAnimation;
...
public class ViewAnimator<T extends Resourceble> {
    ...
    public interface ViewAnimatorListener {
        ...
        void onSwitch(Resourceble slideMenuItem, int position);
